...
## Naming Para o Usuario — Nomes Publicos Simplificados

Os nomes tecnicos internos existem para clareza metodologica. Para o usuario final, use os nomes abaixo — mais proximos da forma como o publico pensa a propria jornada:

| Nome Interno (Repositorio) | Nome Publico (Copy e Vendas) | Situacao de Uso |
|---|---|---|
| Protocolo do Escudo — 72h | **"Primeiras 72h"** ou **"Protocolo de Crise"** | Quando estou em crise ou recaida agora |
| Mapa dos 13 Fundamentos | **"Mapa do Metodo"** | Quando quero entender o sistema antes de comecar |
| Programa O Guardiao — 30 Dias | **"Primeiros 30 Dias"** | Quando quero comecar com estrutura completa |
| Plano de Correcao — 14 Dias | **"Recomeco em 14 Dias"** | Quando perdi o ritmo e preciso retomar |
| Comunidade O Escudo | **"Comunidade"** ou **"O Escudo"** | Quando quero pertencer a uma rede de apoio continuo |
| Guia do Familiar | **"Escudo da Familia"** | Quando sou familiar ou conjuge de quem bebe |

> O nome interno e o nome do produto. O nome publico e o que aparece no CTA, no titulo da pagina de vendas e no copy do video.
...
**Jornada do produto:**
- **Para quem e:** Quem acabou de recair ou sente o perimetro cedendo — precisa de estrutura hora a hora, nao de conceito
- **Quando usar:** Nas primeiras 72h apos uma recaida, ou quando o impulso esta forte e sem estrutura de apoio imediata
- **O que vem antes:** Conteudo TATICA ou ESCUDO no TikTok; Checklist do Escudo como isca gratuita
- **O que vem depois:** Plano de Correcao — 14 Dias (retomada do ritmo) ou Programa O Guardiao — 30 Dias (estrutura completa)
...
**Jornada do produto:**
- **Para quem e:** Quem esta nos primeiros 30 dias e quer entender o sistema completo antes de agir — o publico que precisa do mapa antes do territorio
- **Quando usar:** Logo no inicio do processo, como base metodologica para todas as outras ferramentas
- **O que vem antes:** Videos ESPELHO, especialmente a serie de fundamentos; Diario de Prompts como isca gratuita
- **O que vem depois:** Programa O Guardiao — 30 Dias (aplicacao pratica do metodo com estrutura diaria)
...
**Jornada do produto:**
- **Para quem e:** Quem quer os primeiros 30 dias com estrutura completa — nao so um protocolo de emergencia, mas um sistema diario
- **Quando usar:** Quando ha decisao clara de parar e vontade de seguir um metodo — nao em crise aguda (para isso: Protocolo 72h primeiro)
- **O que vem antes:** Qualquer produto de entrada (Protocolo 72h ou Mapa dos Fundamentos) ou direto do funil de email (Email do Dia 30)
- **O que vem depois:** Comunidade O Escudo (manutencao e suporte continuo pos-30 dias)
...
**Jornada do produto:**
- **Para quem e:** Quem ja conhece o metodo, parou por algum motivo e precisa retomar — nao e para quem esta comecando do zero
- **Quando usar:** Depois de uma pausa, queda de ritmo ou recaida em quem ja tinha alguma base de sobriedade
- **O que vem antes:** Protocolo 72h (se veio de recaida recente) ou Mapa dos Fundamentos (se perdeu a base conceitual)
- **O que vem depois:** Retomada do Programa 30 Dias ou renovacao da Comunidade O Escudo
...
**Jornada do produto:**
- **Para quem e:** Quem ja conhece e usou o metodo e quer acompanhamento personalizado — nao e entrada no funil
- **Quando usar:** Somente apos ter passado por pelo menos um produto pago e demonstrado comprometimento com o processo
- **O que vem antes:** Obrigatoriamente um produto de entrada (Protocolo 72h ou Mapa) ou o Programa 30 Dias
- **O que vem depois:** Manutencao via Comunidade O Escudo quando a mentoria encerrar
...
Combinacoes de produtos para aumentar o ticket medio. Ver detalhes, precos e quando ativar em:

`/produtos/bundles-e-pacotes.md`

| Bundle | Composicao | Preco |
|---|---|---|
| Escudo Completo | Protocolo 72h + Plano 14 Dias | R$ 117 |
| Guardiao em Construcao | Programa 30 Dias + 1 mes Comunidade | R$ 217 |
| Stack de Entrada | Protocolo 72h + Mapa 13 Fundamentos | R$ 77 |
